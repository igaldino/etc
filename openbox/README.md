# Install
```
sudo dnf install openbox compton obconf nitrogen tint2 volumeicon network-manager-applet redshift-gtk python2-gobject xdotool dunst rofi numix-gtk-theme numix-icon-theme-circle
```
